...
{/* Profile card */} <div className="bg-[#111] rounded-2xl border border-[#1a1a1a] p-5 text-center"> <div className="h-16 w-16 rounded-full bg-[rgba(0,255,65,0.1)] border-2 border-[rgba(0,255,65,0.25)] flex items-center justify-center mx-auto mb-3"> <User size={28} className="text-[#00ff41]" /> </div> <h2 className="text-base font-bold">@{profile?.username ?? "User"}</h2> <p className="text-xs text-gray-500 mt-0.5">{profile?.phone ?? ""}</p>
