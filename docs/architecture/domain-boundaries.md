...
| Crypto deposits | `/deposit`, `NowpaymentsUsdtDeposit`, NOWPayments deposit Functions | NOWPayments plus `nowpayments_usdt_*` deposit tables | provider communication and financial settlement are distinct responsibilities |
