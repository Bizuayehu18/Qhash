...
revoke all on function public.increment_wallet_balance(uuid, numeric) from anon;
revoke all on function public.increment_wallet_balance(uuid, numeric) from authenticated;
