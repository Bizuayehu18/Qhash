...
const allTests = [
  ...
  "admin-fiat-deposit-operations-ui.test.mjs",
  "admin-fiat-withdrawal-operations-ui.test.mjs",
  ...
  "notifications-route-compatibility.test.mjs",
  "notifications-ui.test.mjs",
  ...
  "shared-non-array-object-validation.test.mjs",
  "shared-timestamp-validation.test.mjs",
